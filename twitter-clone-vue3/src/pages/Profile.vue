  ...
  <div class="flex-1 flex" v-if="profileUser">
    ...
    <div class="flex-1 flex-col border-r border-color">
      ...
      <div class="bg-gray-300 h-48 relative flex-none">
        <!-- background image -->
        <img :src="profileUser.background_image_url" class="h-48 w-full object-cover"/>
        <!-- profile image -->
        <div
            class="
            w-28
      ...
      <!-- profile edit button -->
      <div class="text-right mt-2 mr-2 h-10 relative">
      ...
      <div class="overflow-y-auto">
        <Tweet
            ...
            :key="tweet.id"
            :currentUser="currentUser" :tweet="tweet"/>
      </div>
    </div>
