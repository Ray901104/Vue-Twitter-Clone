      ...
      <div class="flex flex-col h-screen">
        ...
        >
          ...
          <div>
            ...
            <span class="font-bold ml-3 mr-1">{{ selectedUser.followers.length }}</span
...
import {USER_COLLECTION, MESSAGE_COLLECTION} from "../firebase";
...
export default {
  setup() {
    ...
    const onSelectUser = async (user) => {
      ...
      let snapshot = await MESSAGE_COLLECTION
      ...
      snapshot = await MESSAGE_COLLECTION
